...
const AboutMe = () => {
  return (
    <motion.section
      className="flex flex-col md:flex-row items-center gap-8 mt-8 px-4"
    ...
    >
      <img 
        src={profilePic}
        alt="Profile"
        className="w-40 h-40 sm:w-48 sm:h-48 rounded-full border-4 border-blue-400 shadow-lg"
      />
      <div className="text-left">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Hi there! 👋 I'm Tristan Ira</h2>
