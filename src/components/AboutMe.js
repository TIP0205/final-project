    ...
    >
      ...
      <div className="text-left">
        ...
        <p className="text-lg leading-relaxed max-w-xl">
          I'm a IT student with a strong interest in frontend development and user experience design. I'm currently learning React, Tailwind CSS, and JavaScript, and I love building clean, responsive interfaces.
        </p>
